...
<template>
  <div aria-live="polite"
    ...
    <TransitionGroup enter-active-class="transition ease-out duration-150"
      ...
      <div v-for="t in toasts"
        ...
        <div :class="cn('absolute bottom-0 left-0 h-1 transition-[width] duration-100 ease-linear', VARIANTS[t.kind].bar)"
