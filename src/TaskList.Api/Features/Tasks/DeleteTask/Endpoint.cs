...
public sealed class DeleteTaskEndpoint : IEndpointGroup
{
    ...
    private static async Task<Results<NoContent, ProblemHttpResult>> HandleAsync(Guid id, ICommandHandler<DeleteTaskCommand, Result> handler, CancellationToken cancellationToken)
    {
