...
public class Result
{
    ...
    public static Result Success() => new(isSuccess: true, DomainError.None);

    public static Result<T> Success<T>(T value) => new(value);

    public static Result Failure(DomainError error) => new(isSuccess: false, error);
...
public sealed class Result<T> : Result
{
    ...
    internal Result(T value) : base(isSuccess: true, DomainError.None) => _value = value;

    internal Result(DomainError error) : base(isSuccess: false, error) => _value = default;
